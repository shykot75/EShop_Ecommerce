            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#"><i class="icon fa fa-heart"></i>@if(session()->get('language') == 'bangla') উইসলিস্ট  @else Wishlist @endif </a></li>
                        ...
                        @auth
                            <li><a href="{{ route('dashboard') }}"><i class="icon fa fa-user"></i>@if(session()->get('language') == 'bangla') ইউজার প্রোফাইল  @else User Profile @endif </a></li>
                        @else
                            <li><a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>@if(session()->get('language') == 'bangla') লগইন  @else Login @endif  </a></li>
                            <li><a href="{{ route('register') }}"><i class="icon fa fa-user-plus"></i> @if(session()->get('language') == 'bangla') রেজিস্টার  @else Register @endif </a></li>
                        @endauth
                    </ul>
                </div>
                <!-- /.cnt-account -->
                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="active dropdown yamm-fw"> <a href="{{ route('home') }}" > @if(session()->get('language') == 'bangla') হোম  @else Home @endif </a> </li>
                                @php
                                    $categories = \App\Models\Category::orderBy('category_name_en', 'ASC')->get();
                                @endphp
                                @foreach($categories as $category) <!-- for category starts -->
                                <li class="dropdown yamm mega-menu"> <a href="" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown"> @if(session()->get('language') == 'bangla') {{$category->category_name_ban}}  @else {{$category->category_name_en}} @endif </a>
                                    <ul class="dropdown-menu container">
                                        <li>
                                            <div class="yamm-content ">
                                                ...
                                                @endforeach <!-- for subcategory Ends -->
