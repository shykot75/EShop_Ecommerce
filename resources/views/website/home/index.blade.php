    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <!-- ================================== TOP NAVIGATION ================================== -->
               @include('website.body.vertical-menu')
                <!-- ================================== TOP NAVIGATION : END ================================== -->

                <!-- ============================================== HOT DEALS ============================================== -->
                <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
                    <h3 class="section-title"> @if(session()->get('language') == 'bangla') হট ডিলস  @else hot deals @endif </h3>
...
{{--                                        <div class="sale-offer-tag"><span></span></div>--}}
                                    @else
                                ...
                                <div class="product-info text-left m-t-20">
                                    <h3 class="name"><a href="{{ route('product.details', ['id' => $product->id, 'slug' => $product->product_slug_en]) }}">@if(session()->get('language') == 'bangla') {{ $product->product_name_ban }}  @else {{ $product->product_name_en }} @endif</a></h3>
                ...
                <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                    <h3 class="section-title"> @if(session()->get('language') == 'bangla') বিশেষ অফারস  @else Special Offer @endif </h3>
                ...
                <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                    <h3 class="section-title"> @if(session()->get('language') == 'bangla') বিশেষ ডিলস  @else Special Deals @endif </h3>
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                ...
                <!-- ============================================== Testimonials============================================== -->
                     @include('website.body.testimonials')
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    <div class="more-info-tab clearfix ">
                        <h3 class="new-product-title pull-left"> @if(session()->get('language') == 'bangla') নতুন পন্যগুলো  @else New Products @endif </h3>
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            <li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">All</a></li>
                            @foreach($categories as $category)
                            <li><a data-transition-type="backSlide" href="#category{{$category->id}}" data-toggle="tab"> @if(session()->get('language') == 'bangla') {{$category->category_name_ban}}  @else {{$category->category_name_en}} @endif </a></li>
                            @endforeach
...
{{--                            <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Shoes</a></li>--}}
                    ...
                    <div class="tab-content outer-top-xs">
                        ...
                        <div class="tab-pane " id="category{{$category->id}}" >
                            <div class="product-slider">
                             @php
                             $catWiseData = \App\Models\Product::where('category_id',$category->id)->orderBy('id', 'DESC')->limit(10)->get();
                             @endphp

                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    @forelse($catWiseData as $product)
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                        ...
                                        <!-- /.item -->
                                    @empty
                                        <h4 class="text-danger text-center"> @if(session()->get('language') == 'bangla') কোনো পন্য পাওয়া যায় নি!!  @else No Products Found!! @endif </h4>
                                    @endforelse
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title"> @if(session()->get('language') == 'bangla') ফিচারস পন্যগুলো  @else Featured products @endif </h3>
                ...
                <!-- ============================================== SKIP PRODUCTS 0 ============================================== -->
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title"> @if(session()->get('language') == 'bangla') {{ $skip_category_0->category_name_ban }} ক্যাটাগরি   @else {{ $skip_category_0->category_name_en }} Category @endif </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                ...
                <!-- ============================================== SKIP PRODUCTS 3============================================== -->
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title"> @if(session()->get('language') == 'bangla') {{ $skip_category_3->category_name_ban }} ক্যাটাগরি   @else {{ $skip_category_3->category_name_en }} Category @endif </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
