        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    <li><a href="#"> @if(session()->get('language') == 'bangla') {{ $product->category->category_name_ban }}  @else {{ $product->category->category_name_en }} @endif  </a></li>
                    <li class='active'> @if(session()->get('language') == 'bangla') {{ $product->product_name_ban }}  @else {{ $product->product_name_en }} @endif  </li>
                </ul>
                                ...
                                <div class="item">
                                    <div class="products">
                                        ...
                                        <div class="product-info text-left m-t-20">
                                            <h3 class="name"><a href="detail.html"> Floral Print </a></h3>
                        ...
                        <div class="row  wow fadeInUp">
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    <h2 class="name">@if(session()->get('language') == 'bangla') {{ $product->product_name_ban }}  @else {{ $product->product_name_en }} @endif  </h2>
                                    ...
                                    <div class="description-container m-t-20">
                                        @if(session()->get('language') == 'bangla') {{ $product->short_desc_ban }}  @else {{ $product->short_desc_en }} @endif
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="description" class="tab-pane in active">
                                        <div class="product-tab">
                                            <p class="text"> @if(session()->get('language') == 'bangla') {!! $product->long_desc_ban !!}  @else {!! $product->long_desc_en !!} @endif </p>
                                        </div>
                                    </div><!-- /.tab-pane -->
